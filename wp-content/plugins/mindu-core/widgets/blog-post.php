...
class Mindu_Blog_post extends \Elementor\Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Theme Blog Post', 'elementor-addon' );
	}
	...
	protected function register_controls_section(){
		...
		$this->add_control(
			'post_per_page',
			[
				'label' => esc_html__( 'Post Number', 'elementor-addon' ),
		...
		if( !empty($settings['cat_include']) ) {
			$args['tax_query'] = array(
				array(
					'taxonomy' => 'category',
					'field'    => 'slug',
					'terms'    => $settings['cat_include'], // Array of category IDs
				),
			);
		}
