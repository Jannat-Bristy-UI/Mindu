    ...
    protected function register_controls(): void {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'style_1',
                'options' => [
                    'style_1' => esc_html__( 'Layout 01', 'elementor-addon' ),
                    'style_2' => esc_html__( 'Layout 02', 'elementor-addon' ),
                    'style_3' => esc_html__( 'Layout 03', 'elementor-addon' ),
                ],
            ]
        );
        ...
        // ==========================================
        // CONTENT TAB: TESTIMONIAL REPEATER
        // ==========================================
        $this->start_controls_section(
            'section_list',
            [
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'I need to get a certification for English proficiency and Acadia is my best choice.', 'elementor-addon' ),
            ]
        );

        // Image Control with Description Notice
        $repeater->add_control(
            'image',
            [
                ...
                'description' => esc_html__( 'Recommended Sizes — Style 1: 540x530px | Style 2: 60x60px | Style 3: 266x412px', 'elementor-addon' ),
            ]
        );
        ...
        // Logo Control with Description Notice
        $repeater->add_control(
            'logo',
            [
                'label'       => esc_html__( 'Choose Logo', 'elementor-addon' ),
                'type'        => \Elementor\Controls_Manager::MEDIA,
                'default'     => [
                    'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],
                'description' => esc_html__( 'Recommended Logo Size: 188x45px (Style 3 only)', 'elementor-addon' ),
            ]
        );
        ...
        $this->add_control(
            'list',
            [
                'label'       => esc_html__( 'Testimonial List', 'elementor-addon' ),
        ...
        // ==========================================
        // STYLE TAB: GENERAL & IMAGE STYLES
        // ==========================================
        $this->start_controls_section(
            'section_title_style',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-testimonial-name span' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-testimonial-thumb img, {{WRAPPER}} .tp-testimonial-2-avatar img, {{WRAPPER}} .tp-testimonial-3-thumb img' => 'object-fit: {{VALUE}};',
                ],
            ]
        );
        ...
        <?php if ( $settings['design_layout'] === 'style_2' ) : ?>
            ...
            <div class="tp-testimonial-area" data-bg-color="#fbf9f5">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="swiper tp-testimonial-2-slide">
            ...
            <div class="tp-testimonial-area">
                <div class="container">
                    <div class="row">
                        <?php foreach ( $settings['list'] as $item ) : ?>
                            <div class="col-xxl-6">
                                <div class="tp-testimonial-3-item fix mb-30">
                                        ...
                                        <div class="col-md-8">
                                            <div class="tp-testimonial-3-content ml-35">
                                                <?php if ( ! empty( $item['logo']['url'] ) ) : ?>
                                                    <img class="testimonial-logo mb-50" src="<?php echo esc_url( $item['logo']['url'] ); ?>" alt="">
                                                <?php endif; ?>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="tp-testimonial-content mb-30">
                                                        ...
                                                        <?php if ( ! empty( $item['content'] ) ) : ?>
                                                            <p class="tp-testimonial-dec tp-ff-heading fw-600 mb-75"><?php echo esc_html( $item['content'] ); ?></p>
                                                        <?php endif; ?>
