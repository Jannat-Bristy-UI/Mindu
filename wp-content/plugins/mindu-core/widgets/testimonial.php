...
class Mindu_Testimonial extends \Elementor\Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Testimonial Slider', 'elementor-addon' );
	}
										...
										<div class="row align-items-center">
											...
											<div class="col-lg-6">
												<div class="tp-testimonial-content mb-30">
													...
													<p class="tp-testimonial-dec tp-ff-heading fw-600 mb-75"><?php echo mc_kses($item['content']); ?></p>
													<div class="tp-testimonial-name">
														<span class="tp-ff-heading fw-600"><?php echo mc_kses($item['name']); ?></span>
														<p class="mb-0"><?php echo mc_kses($item['designation']); ?></p>
													</div>
												</div>
											</div>
										</div>
