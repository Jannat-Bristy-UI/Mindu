<?php
class Mindu_Team_Slider extends \Elementor\Widget_Base {

	use Typo_Style_Controls;

	// ====== widgets Information ======
	public function get_name(): string {
		return 'mindu-team-slider';
	}

	public function get_title(): string {
		return esc_html__( 'Team Slider', 'elementor-addon' );
	}
	...
	protected function register_controls_section(): void {
		...
		$this->start_controls_section(
			'section_slider',
			[
				'label' => esc_html__( 'Team Slider', 'elementor-addon' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$repeater->start_controls_tabs(
			...
			$repeater->start_controls_tab(
				'style_normal_tab',
				[
					'label' => esc_html__( 'Information', 'text-domain' ),
				]
			);
			...
			$repeater->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::TEXT,
					'placeholder' => esc_html__( '#', 'text-domain' ),
					'label_block' => true,
				]
			);
	...
	protected function register_style_section(){
		...
		$this->typo_style_controls('name', 'Name', '.el-name');
		$this->typo_style_controls('designation', 'Designation', '.el-designation');
										...
										<div class="tp-team-3-content p-absolute d-flex align-items-center justify-content-between">
											...
											<div>
												...
												<?php if(!empty($item['title'])) : ?>
													<h2 class="tp-team-3-name mb-5"><a href="<?php echo esc_html($item['url']); ?>"><?php echo esc_html($item['name']); ?></a></h2>
												<?php endif; ?>
						...
						<div class="col-lg-12">
							<div class="swiper tp-team-slider wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
								<div class="swiper-wrapper">
									...
									<!-- Foreach Loop for Slider -->
									<?php foreach($settings['list'] as $item) : ?>
										<div class="swiper-slide">
											<div class="tp-team-wrap tp-team-2-wrap">

												<!-- Profile Image & Social Icon Link -->
												<?php if(!empty($item['image']['url'])) : ?>
													<div class="tp-team-thumb p-relative mb-25">
														...
														<div class="tp-team-social p-absolute">
															...
															<!-- Dribble -->
															<?php if(!empty($item['dribbble_url'])) : ?>
															...
															<!-- Instagram -->
															<?php if(!empty($item['instagram_url'])) : ?>
												...
												<div class="tp-team-content text-center">
													...
													<?php if(!empty($item['url'])) : ?>
														<h2 class="tp-team-title el-name fw-600 mb-5">
															<a href="<?php echo esc_html($item['url']); ?>"><?php echo esc_html($item['name']); ?></a>
														</h2>
													<?php endif; ?>

													<!-- Designation -->
													<?php if(!empty($item['designation'])) : ?>
														<span class="tp-team-subtitle el-designation"><?php echo esc_html($item['designation']); ?></span>
													<?php endif; ?>
												</div>
											</div>
										</div>
...
$widgets_manager->register( new Mindu_Team_Slider() );