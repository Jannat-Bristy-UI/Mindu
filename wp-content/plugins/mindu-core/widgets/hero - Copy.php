				...
				<div class="row align-items-end">
					...
					<div class="col-xxl-4 col-xl-5">
						<div class="tp-hero-2-form text-center wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
							<h2 class="tp-hero-2-form-title fw-700 mb-25"><?php echo mc_kses($settings['form_title']); ?></h2>
							<?php if(!empty($settings['form_shortcode'])) : ?>	
				...
				<div class="row align-items-end">
					<div class="col-xl-7">
						<div class="tp-hero-content mb-40">
							...
							<p class="tp-hero-dec mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s"><?php echo mc_kses($settings['content']); ?></p>
							<?php endif; ?>	
