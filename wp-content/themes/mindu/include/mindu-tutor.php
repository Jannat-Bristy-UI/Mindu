...
function mindu_course_grid(){
    ...
    $total_lessons = tutor_utils()->get_lesson_count_by_course($course_id);  //Lesson Count Function of Tutor LMS
    $students = tutor_utils()->get_student_count_by_course($course_id);  //Student Count Function of Tutor LMS
    ...
    $final_price = ($price == null) ? 'Free' : $price;

    // Get Course Category Function of Tutor LMS
    $cats = get_the_terms( $course_id, 'course-category' );

    ?>

    <!-- Course Item- HTML Markup -->
    <div class="tp-course-item p-relative fix mb-30 ">
        ...
        <div class="tp-course-content">
            ...
            <!-- Course Tags -->
            <!-- ======= This Function For Display Category Tags of the Course ==== -->
            ...
            <div class="tp-course-meta">
                <span> 
                    ...
                    <!-- Display Lesson Count Dynamic Function -->
                    <?php echo esc_html($total_lessons); ?> <?php echo esc_html__('Lessons', 'mindu'); ?>
                </span>
                ...
                <span> 
                    ...
                    <!-- Display Student Count Dynamic Function -->
                    <?php echo esc_html($students); ?> <?php echo esc_html__('Students', 'mindu'); ?>
                </span>
            ...
            <div class="tp-course-rating d-flex align-items-end justify-content-between">
                ...
                <div class="tp-course-rating-star">
                    <p><?php echo esc_html( apply_filters( 'tutor_course_rating_average', $course_rating->rating_avg ) ); ?><span> /<?php echo esc_html( $course_rating->rating_count > 0 ? $course_rating->rating_count : 0 ); ?></span></p>
        ...
        <div class="tp-course-btn">
            <a href="<?php the_permalink(); ?>"><?php echo esc_html__('Preview this Course', 'mindu'); ?></a>
        </div>
    </div>
