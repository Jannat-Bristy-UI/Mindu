<?php if(is_single()) : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox-item mb-45'); ?>>
      <div class="tp-blog-item mb-40">
         ...
         <?php echo get_template_part( 'template-parts/blog/post-format' ); ?>

         <div class="tp-blog-content">
            <?php echo get_template_part( 'template-parts/blog/blog-meta' ); ?>
            <h3 class="tp-blog-title fs-32 fw-600 mb-15"><?php the_title(); ?></h3>
            
            <div class="tp-blog-content-details">           
             <?php the_content(); ?>
             </div>
    ...
    <!-- Single Blog share content (meta tags & social link)-->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="tp-blog-details-social d-flex align-items-center justify-content-md-end mb-10">
                    ...
                    <!-- X / Twitter -->
                    <a href="https://twitter.com/intent/tweet?url=<?php echo esc_url( $post_url ); ?>&text=<?php echo esc_attr( $post_title ); ?>" target="_blank">
...
<?php else : ?>
    <!-- Post list with unique ID and WordPress default classes -->
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox-item mb-45'); ?>>
        <div class="tp-blog-item mb-40">
            <?php echo get_template_part( 'template-parts/blog/post-format' ); ?>
            ...
            <div class="tp-blog-content">
               ...
               <!-- Dynamically generated excerpt for short description -->
               <?php the_excerpt(); ?>
            </div>
