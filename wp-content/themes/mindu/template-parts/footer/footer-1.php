            ...
            <div class="container pt-135 pb-100">
                <div class="row">                       
                    <?php if (is_active_sidebar('footer-1-widget-1')): ?>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
                            <?php dynamic_sidebar( 'footer-1-widget-1' ); ?>
                        </div>
                    <?php endif; ?>
                    
                    <?php if (is_active_sidebar('footer-1-widget-2')): ?>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">
                            <?php dynamic_sidebar( 'footer-1-widget-2' ); ?>
                        </div>
                    <?php endif; ?>
                    
                    <?php if (is_active_sidebar('footer-1-widget-3')): ?>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
