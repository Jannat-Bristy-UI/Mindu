<?php 
   ...
   $header_top_switcher = $mindu['header-top-switcher'] ?? '';
   $header_phone = $mindu['header-phone'] ?? '';
   $header_mail = $mindu['header-mail'] ?? '';
...
<header class="tp-header-height">
   ...
   <!-- Header Top Area -->
   <?php if ($header_top_switcher == true) : ?>  
                  ...
                  <div class="tp-header-top-info d-flex align-items-center">
                     ...
                     <?php if (!empty($header_phone)) : ?>
                        <span class="mr-30 d-inline-block">
                           ...
                           <!-- Call Us Title Escaping for security -->
                     ...
                     <?php if (!empty($header_mail)) : ?>
                        <span>
                           ...
                           <!-- Email Title Escaping for security -->
                           <?php echo esc_html__('Email:', 'mindu'); ?>
                           <a href="mailto:<?php echo esc_attr($header_mail); ?>"><?php echo esc_html($header_mail); ?></a>
                        </span>
                     <?php endif; ?>
            ...
            <div class="col-xl-3 col-7">
               <div class="tp-header-option tp-header-2-option d-flex align-items-center justify-content-end">
                  ...
                  <?php if (!empty($header_button_text)) : ?>                    
                     <a href="<?php echo esc_url($header_button_url); ?>" class="tp-btn ml-10 d-none d-sm-block"><?php echo esc_html($header_button_text); ?>
                        <span class="ml-8">
