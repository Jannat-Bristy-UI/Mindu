...
<!--==========
Header split into 3 separate parts for better organization.
Using this PHP functions to connect 3 separate header parts to the main header.
===========-->
<!-- Connect to Header-Search page -->
<?php get_template_part('template-parts/header/header-search'); ?>

<!-- Connect to Header-offcanvas (Mobile Menu) page -->
<?php get_template_part('template-parts/header/header-offcanvas'); ?>

<!-- Connect to Main header page -->
<?php mindu_header(); ?>
...
<body <?php body_class('body-bg-3'); ?>>
   ...
   <!-- style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/hero/thumb-test.jpg);" -->
         ...
         <div class="row">
            <div class="col-12">
               <div class="tp-breadcrumb-3-content text-center">
                  ...
                  <h2 class="tp-breadcrumb-title text-black mb-0 fw-700 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">Blog _ Standard</h2>
               </div>
            </div>
         </div>
      </div>
